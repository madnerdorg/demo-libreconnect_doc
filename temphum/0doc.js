...
(function() {
    ...
    function render() {
        ...
        //Transform images with youtube as alt into a youtube embded HTML5 video
        if(youtube_link){
           imgyoutube()
        }
        ...
        for (var i = 0; i < list.length; i++) {
            ...
            if(title_description){
                /* Hack First # tags for title/description in the sidebar*/
                if(i == 0){            
                    document.getElementById("title").innerHTML = e.textContent;
                }  else if (i == 1){
                    document.getElementById("description").innerHTML = e.textContent;
                }  else { 
                    if (e.tagName == "H1") {
        ...
        function imgyoutube(){
            ...
            for (var i = 0; i < list.length; i++) {
                console.log(list[i].alt);
                if(list[i].alt == "youtube"){
                    var link_array = list[i].src.split("/");
                    var yt_link = link_array[link_array.length -1];
                    newItem = '<object style="width:350px;height:250px" data="http://www.youtube.com/embed/'+yt_link+'"></object>';
                    list[i].parentNode.innerHTML = newItem;  
                }
            }
        }
